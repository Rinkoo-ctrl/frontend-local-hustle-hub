...
const ServiceList = () => {
    ...
    const fetchServices = async () => {
        try {
            ...
            const Hustleuser = JSON.parse(localStorage.getItem("Hustleuser"));
            console.log(Hustleuser.freelancerProfile._id, "free id")
            const res = await axios.get(`${backendBaseUrl}/api/services/${Hustleuser.freelancerProfile._id}`, {
